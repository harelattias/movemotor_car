...
def on_received_string(receivedString):
    global stop_by_dist
    if receivedString.compare("on_dis") == 0:
        stop_by_dist = 1
    if receivedString.compare("off_dis") == 0:
        stop_by_dist = 0
...
def on_forever():
    ...
    if filtered_distance < 5 and speed_left_motor + speed_right_motor > 0 and stop_by_dist == 1:
